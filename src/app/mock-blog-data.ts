...
export const WrittenBlogs: BlogData[] = [
  { id: 1, author: 'Burak',entryDate : new Date(), header: "About My New Angular App", text : "As you can already see i am trying to learn angular and trying to do some blog web site, why blog because you can add edit and delete blogs and other people can easly see what you did.",comments:{loading:false,list :[""]}},
  ...
  { id: 4, author: 'Legend',entryDate : new Date(), header: "About me",text : "Yes you heard right! I am legend. Do you have any further question?",comments:{loading:false,list :[""]} },
